...
$posts = selectAll2('posts','id_city',$_GET['id_city'] , 'id_topic', $_GET['id_category'], 'id_post');
$category = selectOne('topics', ['id_topic' => $_GET['id_category']]);
?>
<html lang="ru">
...
<head>
    ...
    <title>Достопримечательности Удмуртской Республики — Сортировать по...</title>
</head>
            ...
            <div class="container my-5">
                <div class="sights_block">
                    ...
                    <p class='hidden'><?=$city = selectOne('cities', ['id_city' => $_GET['id_city']]); ?></p>
                        <p class="txt30"><span style="text-decoration:underline;">
                                <?= $category['title_topic']; ?></span>, <span class="r"><?=$city['name_city']; ?></span></p>
